...
start "Electional Python Runner" "%PYTHONW%" -m idlelib -i -c "print('Electional Software Python Runner'); print('Project:', r'%PROJECT_DIR%'); print('Tip: from backend.electional.chart import build_snapshot')"
